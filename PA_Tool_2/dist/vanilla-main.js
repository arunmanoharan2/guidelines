...
// browser-spreadsheet-utils.ts
class BrowserSpreadsheetProcessor {
  data = [];
  constructor() {
  ...
  get_criteria(program, cptCode) {
    const matchingRow = this.data.find((row) => row.Program === program && row["CPT Code"] === cptCode);
    if (!matchingRow) {
      return null;
    }
    return {
...
var VanillaPAAssistTool = () => {
  const [processor, setProcessor] = import_react.useState(null);
  const [dropdownValues, setDropdownValues] = import_react.useState(null);
  const [selectedProgram, setSelectedProgram] = import_react.useState("");
  const [selectedCPTCode, setSelectedCPTCode] = import_react.useState("");
  const [criteriaResult, setCriteriaResult] = import_react.useState(null);
  ...
  const handleGetCriteria = async () => {
    if (!processor || !selectedProgram || !selectedCPTCode)
      return;
  ...
  const formatText = (text) => {
    return text.split(`
`).map((line, index) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
      style: { margin: "8px 0", lineHeight: "1.5" },
      children: line
    ...
    return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      ...
      children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h2", {
          children: "Loading PA Assist Tool..."
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h1", {
            style: styles.title,
            children: "PA Assist Tool"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
            style: styles.subtitle,
            children: "Prior Authorization Clinical Criteria Assistant"
          }, undefined, false, undefined, this)
        ]
        ...
        children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("select", {
                    ...
                    children: [
                      ...
                      dropdownValues?.programs.map((program) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("option", {
                        value: program,
                        children: program
                      }, program, false, undefined, this))
                    ]
                  }, undefined, true, undefined, this)
                ]
              }, undefined, true, undefined, this),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("select", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("option", {
                        value: "",
                        children: "Select CPT Code"
                      }, undefined, false, undefined, this),
                      dropdownValues?.cptCodes.map((code) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("option", {
                        value: code.toString(),
                        children: code
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
              ...
              children: isSubmitting ? "Getting Criteria..." : "Get Criteria"
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      ...
      criteriaResult && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h3", {
                style: { ...styles.sectionTitle, ...styles.greenTitle },
                children: "Simplified Clinical Criteria"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
                children: formatText(criteriaResult["Simplified Clinical Criteria"])
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h3", {
                style: { ...styles.sectionTitle, ...styles.purpleTitle },
                children: "Docs to Upload"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
                children: formatText(criteriaResult["Docs To Upload"])
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this)
        ]
      ...
      criteriaResult && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h3", {
            style: { ...styles.sectionTitle, ...styles.orangeTitle },
            children: "Clinical Criteria"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            children: formatText(criteriaResult["Clinical Criteria"])
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this)
    ]
...
var VanillaPAAssistTool_default = VanillaPAAssistTool;
...
root.render(/* @__PURE__ */ jsx_dev_runtime2.jsxDEV(VanillaPAAssistTool_default, {}, undefined, false, undefined, this));
