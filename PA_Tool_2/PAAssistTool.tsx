...
import { SpreadsheetProcessor, DropdownValues, CriteriaResult } from './spreadsheet-utils';

interface PAAssistToolProps {}

const PAAssistTool: React.FC<PAAssistToolProps> = () => {
  const [processor, setProcessor] = useState<SpreadsheetProcessor | null>(null);
  ...
  useEffect(() => {
    const initializeData = async () => {
      try {
        const proc = new SpreadsheetProcessor();
        await proc.loadDataFromExcel('/Users/arunmanoharan/Documents/AI/PA_Tool/PA Tool.xlsx');
